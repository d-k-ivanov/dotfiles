...
${function:gg}          = { git.exe -c core.pager='delta --features=code-review-dark' @args }
...
${function:ggw}         = { git.exe -c core.pager='delta --features=code-review-dark' show @args              }
${function:ggw^}        = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^ @args        }
${function:ggww}        = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^ @args        }
${function:ggw^^}       = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^ @args       }
${function:ggwww}       = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^ @args       }
${function:ggw^^^}      = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^ @args      }
${function:ggwwww}      = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^ @args      }
${function:ggw^^^^}     = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^ @args     }
${function:ggwwwww}     = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^ @args     }
${function:ggw^^^^^}    = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^ @args    }
${function:ggwwwwww}    = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^ @args    }
${function:ggw^^^^^^}   = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^ @args   }
${function:ggwwwwwww}   = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^ @args   }
${function:ggw^^^^^^^}  = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^ @args  }
${function:ggwwwwwwww}  = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^ @args  }
${function:ggw^^^^^^^^} = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^^ @args }
${function:ggwwwwwwwww} = { git.exe -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^^ @args }

${function:gd}          = { git.exe diff HEAD @args }
${function:ggd}         = { git.exe -c core.pager='delta --features=code-review-dark' diff HEAD @args }
