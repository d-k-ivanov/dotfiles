...
function Initialize-Paths-SYS
{
    $paths = @(
        ...
        "C:\PROGRA~1\NVIDIA~1\Nsight Compute 2021.3.2"
        "C:\PROGRA~1\NVIDIA~1\Nsight Compute 2021.2.2"
        "C:\PROGRA~1\NVIDIA~1\Nsight Compute 2021.1.1"
        "C:\PROGRA~1\NVIDIA~2\CUDA\v11.5\bin"
        "C:\PROGRA~1\NVIDIA~2\CUDA\v11.5\compute-sanitizer"
        "c:\PROGRA~1\NVIDIA~2\CUDA\v11.5\nvvm\bin"
        "C:\PROGRA~1\NVIDIA~2\CUDA\v11.5\libnvvp"
