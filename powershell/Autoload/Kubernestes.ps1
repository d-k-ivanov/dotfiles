...
${function:kdeveu_consul}       = { kdeveu   port-forward --v=6 --address 0.0.0.0 service/consul 8300 8301 8302 8500 8600 }
${function:kdevus_consul}       = { kdevus   port-forward --v=6 --address 0.0.0.0 service/consul 8300 8301 8302 8500 8600 }
...
${function:kdeveu_rabbit}       = { kdeveu   port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
${function:kdevus_rabbit}       = { kdevus   port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
...
${function:kdevopscn_rabbit}    = { kdevopscn port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
${function:kdevopseu_rabbit}    = { kdevopseu port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
${function:kdevopsus_rabbit}    = { kdevopsus port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
...
${function:kstageeu_consul}     = { kstageeu port-forward --v=6 --address 0.0.0.0 service/consul 8300 8301 8302 8500 8600 }
${function:kstageus_consul}     = { kstageus port-forward --v=6 --address 0.0.0.0 service/consul 8300 8301 8302 8500 8600 }
...
${function:kstageeu_rabbit}     = { kstageeu port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
${function:kstageus_rabbit}     = { kstageus port-forward --v=6 --address 0.0.0.0 service/rabbitmq-ha 4369 5672 15672 15692 }
