...
${function:cgen-17-reldebug} = { cmake -G "Visual Studio 15 2017" -A x64 -B build/RelDebug -S . -DCMAKE_BUILD_TYPE=RelWithDebInfo @args }
${function:cgen-17-reldebug} = { cmake -G "Visual Studio 14 2015" -A x64 -B build/RelDebug -S . -DCMAKE_BUILD_TYPE=RelWithDebInfo @args }

${function:cgen-22-debug} = { cmake -G "Visual Studio 17 2022" -A x64 -B build/Debug -S . -DCMAKE_BUILD_TYPE=Debug @args }
${function:cgen-19-debug} = { cmake -G "Visual Studio 16 2019" -A x64 -B build/Debug -S . -DCMAKE_BUILD_TYPE=Debug @args }
${function:cgen-17-debug} = { cmake -G "Visual Studio 15 2017" -A x64 -B build/Debug -S . -DCMAKE_BUILD_TYPE=Debug @args }
${function:cgen-17-debug} = { cmake -G "Visual Studio 14 2015" -A x64 -B build/Debug -S . -DCMAKE_BUILD_TYPE=Debug @args }
${function:cgen-nj-debug} = { cmake -G "Ninja"                 -A x64 -B build/Debug -S . -DCMAKE_BUILD_TYPE=Debug @args }

${function:cgen-22-release} = { cmake -G "Visual Studio 17 2022" -A x64 -B build/Release -S . -DCMAKE_BUILD_TYPE=Release @args }
${function:cgen-19-release} = { cmake -G "Visual Studio 16 2019" -A x64 -B build/Release -S . -DCMAKE_BUILD_TYPE=Release @args }
${function:cgen-17-release} = { cmake -G "Visual Studio 15 2017" -A x64 -B build/Release -S . -DCMAKE_BUILD_TYPE=Release @args }
${function:cgen-15-release} = { cmake -G "Visual Studio 15 2015" -A x64 -B build/Release -S . -DCMAKE_BUILD_TYPE=Release @args }
${function:cgen-nj-release} = { cmake -G "Ninja"                 -A x64 -B build/Release -S . -DCMAKE_BUILD_TYPE=Release @args }
