...
${function:ip-public} = { if ($($args[0])) { curl ipinfo.io/"$($args[0].ToString())" } else { curl ipinfo.io } }
${function:ip-public2} = { curl ifconfig.me }
${function:ip-local} = { Get-NetIPAddress | Format-Table }
