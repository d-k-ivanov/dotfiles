...
function Initialize-Paths-User
{
    $paths = @(
        ...
        "C:\ProgramData\chocolatey\lib\maven\apache-maven-3.9.5\bin"
        "C:\ProgramData\chocolatey\lib\maven\apache-maven-3.9.4\bin"
...
function Initialize-Paths-System
{
    $paths = @(
        ...
        # "C:\PROGRA~2\Microsoft SQL Server\160\DTS\Binn"
