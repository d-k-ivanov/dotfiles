...
alias ggw="git -c core.pager='delta --features=code-review-theme' show"
alias ggw^="git -c core.pager='delta --features=code-review-theme' show HEAD^"
alias ggww="git -c core.pager='delta --features=code-review-theme' show HEAD^"
alias ggw^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^"
alias ggwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^"
alias ggw^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^"
alias ggwwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^^"
alias ggw^^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^"
alias ggwwwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^"
alias ggw^^^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^"
alias ggwwwwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^"
alias ggw^^^^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^^"
alias ggwwwwwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^^"
alias ggw^^^^^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^^^"
alias ggwwwwwwww="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^^^"
alias ggw^^^^^^^^="git -c core.pager='delta --features=code-review-theme' show HEAD^^^^^^^^"
