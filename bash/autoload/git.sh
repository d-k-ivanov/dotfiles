...
alias ggw="git -c core.pager='delta --features=code-review-dark' show"
alias ggw^="git -c core.pager='delta --features=code-review-dark' show HEAD^"
alias ggww="git -c core.pager='delta --features=code-review-dark' show HEAD^"
alias ggw^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^"
alias ggwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^"
alias ggw^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^"
alias ggwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^"
alias ggw^^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^"
alias ggwwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^"
alias ggw^^^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^"
alias ggwwwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^"
alias ggw^^^^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^"
alias ggwwwwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^"
alias ggw^^^^^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^"
alias ggwwwwwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^"
alias ggw^^^^^^^^="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^^"
alias ggwwwwwwwww="git -c core.pager='delta --features=code-review-dark' show HEAD^^^^^^^^"

alias gd="git diff HEAD"
alias ggd="git -c core.pager='delta --features=code-review-dark' diff HEAD"
