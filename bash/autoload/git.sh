...
alias ggw="git -c core.pager='delta --light --features=code-review-light' show"
alias ggw^="git -c core.pager='delta --light --features=code-review-light' show HEAD^"
alias ggww="git -c core.pager='delta --light --features=code-review-light' show HEAD^"
alias ggw^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^"
alias ggwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^"
alias ggw^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^"
alias ggwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^"
alias ggw^^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^"
alias ggwwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^"
alias ggw^^^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^"
alias ggwwwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^"
alias ggw^^^^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^"
alias ggwwwwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^"
alias ggw^^^^^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^^"
alias ggwwwwwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^^"
alias ggw^^^^^^^^="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^^^"
alias ggwwwwwwwww="git -c core.pager='delta --light --features=code-review-light' show HEAD^^^^^^^^"

alias gd="git diff HEAD"
alias ggd="git -c core.pager='delta --light --features=code-review-light' diff HEAD"
